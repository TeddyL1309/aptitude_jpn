...
const QUESTION_TRAIT_MAPPING = {
  // 작업 스타일 관련 질문
  'ws1': ['분석적이고 논리적인', '데이터 중심적이고 객관적인', '체계적이고 구조적 사고가 가능한'],  // 분석적 사고
  'ws2': ['창의적이고 독창적인', '혁신적이고 창의적인', '창의적이고 예술적인'],         // 창의성
  'ws3': ['체계적이고 구조적 사고가 가능한', '실용적이고 기술적으로 정확한', '효율적이고 계획적인'], // 작업 방식
  'ws4': ['세심하고 정확한', '서비스 정신이 투철하고 세심한', '고객 지향적이고 공감 능력이 높은'], // 세부사항 주의력과 서비스 정신
  'ws5': ['전략적이고 분석적인', '체계적이고 전략적인', '예리하고 판단력이 뛰어난'], // 전략적 사고
  // 커뮤니케이션 방식 질문
  ...
  'cm3': ['명료하고 설득력 있는', '논리적이고 분석적인', '전문적이고 박식한'], // 설명 능력
  ...
  // 문제 해결 접근법 질문
  'ps1': ['논리적이고 분석적인', '데이터 중심적이고 객관적인', '체계적이고 구조적 사고가 가능한'], // 분석적 사고
  'ps2': ['체계적이고 구조적 사고가 가능한', '논리적이고 분석적인', '데이터 중심적이고 객관적인'], // 체계적 분석
  'ps3': ['창의적이고 독창적인', '혁신적이고 창의적인', '실용적이고 솔루션 지향적인'], // 창의적 문제 해결
  'ps4': ['고객 중심적이고 서비스 지향적인', '서비스 정신이 투철하고 세심한', '대인관계가 원활하고 사람을 잘 이해하는'], // 고객 중심적 해결
  'ps5': ['전략적이고 분석적인', '시장 감각이 뛰어나고 창의적인', '데이터 중심적이고 객관적인'], // 전략적 사고
  // 환경 선호도 질문
  'en1': ['체계적이고 구조적 사고가 가능한', '안정적이고 신뢰할 수 있는', '분석적이고 논리적인'], // 업무 환경 선호
  'en2': ['논리적이고 분석적인', '꼼꼼하고 규정을 준수하는', '데이터 중심적이고 객관적인'], // 규칙과 구조
  'en3': ['창의적이고 독창적인', '적응력 있는', '혁신적이고 창의적인'], // 적응력과 창의성
  'en4': ['고객 중심적이고 서비스 지향적인', '대인관계가 원활하고 신뢰감 있는', '서비스 정신이 투철하고 세심한'], // 고객 지향
  'en5': ['전략적이고 분석적인', '다재다능하고 유연한', '효율적이고 조직력 있는'], // 멀티태스킹과 전략
  // 가치 및 동기 질문
  'va1': ['고객 중심적이고 서비스 지향적인', '대인관계가 원활하고 사람을 잘 이해하는', '서비스 정신이 투철하고 세심한'], // 서비스 지향
  'va2': ['논리적이고 분석적인', '전문적이고 박식한', '체계적이고 구조적 사고가 가능한'], // 전문성과 분석력
  'va3': ['창의적이고 독창적인', '도전적이고 성취 지향적인', '혁신적이고 창의적인'], // 혁신과 도전
  'va4': ['혁신적이고 창의적인', '전략적이고 분석적인', '창의적이고 추진력 있는'], // 혁신과 전략
  'va5': ['데이터 중심적이고 객관적인', '전략적이고 분석적인', '체계적이고 구조적 사고가 가능한'] // 분석력과 전략
};
...
const QUESTIONS = [
  // 작업 스타일 질문
  {
    id: 'ws1',
    category: 'work_style',
    text: "나는 데이터를 분석하고 논리적으로 문제를 해결하는 것을 즐긴다.",
    type: 'likert'
  },
  {
    id: 'ws2',
  ...
  },
  {
    id: 'ws4',
    category: 'work_style',
    text: "나는 고객의 세세한 요구사항에도 주의를 기울이며 서비스를 제공한다.",
    type: 'likert'
  },
  {
    id: 'ws5',
    ...
    type: 'choice',
    options: [
      { label: "전략 수립 및 분석", value: "strategic" },
  ...
  // 커뮤니케이션 방식 질문
  {
    ...
    text: "나는 다양한 언어로 전문적인 의사소통을 하는 것에 자신이 있다.",
    type: 'likert'
  },
  {
    id: 'cm2',
    category: 'communication',
    text: "고객과의 소통 시 어떤 방식을 더 선호하나요?",
    type: 'choice',
    options: [
      { label: "명확하고 전문적인 정보 전달", value: "direct" },
      { label: "공감적 경청과 관계 형성 중심", value: "relational" }
    ]
  },
  {
    id: 'cm3',
    category: 'communication',
    text: "복잡한 개념이나 정보를 설명할 때 나는:",
    type: 'choice',
    options: [
      { label: "논리적이고 체계적으로 설명", value: "logical" },
      { label: "이해하기 쉽게 예시를 들어 설명", value: "example" }
    ]
  },
  {
    id: 'cm4',
    ...
    type: 'choice',
    options: [
      { label: "논리적 근거를 제시하여 설득", value: "logical" },
      { label: "상대방의 입장을 고려하여 조율", value: "empathetic" }
    ]
  },
  {
    id: 'cm5',
    category: 'communication',
    text: "다양한 문화적 배경을 가진 사람들과 소통할 때 가장 중요하게 생각하는 것은?",
    type: 'choice',
    options: [
      { label: "명확하고 효율적인 의사소통", value: "efficient" },
      { label: "문화적 차이에 대한 이해와 존중", value: "cultural" }
    ]
  },
  // 문제 해결 접근법 질문
  {
    ...
    type: 'choice',
    options: [
      { label: "데이터와 사실에 기반한 분석적 접근", value: "analytical" },
      { label: "직관과 경험에 기반한 접근", value: "intuitive" }
    ]
  },
  {
    id: 'ps2',
    category: 'problem_solving',
    text: "나는 문제의 근본 원인을 파악하기 위해 체계적으로 분석하는 것을 선호한다.",
    type: 'likert'
  },
  {
    id: 'ps3',
    category: 'problem_solving',
    text: "새로운 해결책을 찾을 때 나는:",
    type: 'choice',
    options: [
      { label: "창의적이고 혁신적인 방법 모색", value: "creative" },
      { label: "검증된 방법의 최적화", value: "proven" }
    ]
  },
  {
    id: 'ps4',
    category: 'problem_solving',
    text: "고객 관련 문제 해결 시 가장 중요하게 생각하는 것은?",
    type: 'choice',
    options: [
      { label: "고객 만족도와 경험", value: "satisfaction" },
      { label: "효율성과 비용 효과", value: "efficiency" }
    ]
  },
  {
    id: 'ps5',
    ...
    type: 'choice',
    options: [
      { label: "데이터 기반 분석적 판단", value: "analytical" },
      { label: "시장 트렌드와 직관적 판단", value: "intuitive" }
    ]
  },
  // 환경 선호도 질문
  {
    ...
    text: "어떤 업무 환경을 선호하나요?",
    type: 'choice',
    options: [
      { label: "체계적이고 구조화된 환경", value: "structured" },
      { label: "유연하고 자율적인 환경", value: "flexible" }
    ]
  },
  {
    id: 'en2',
    ...
    type: 'choice',
    options: [
      { label: "명확한 규칙과 절차 준수", value: "rules" },
      { label: "상황에 따른 유연한 대응", value: "flexible" }
    ]
  },
  {
    id: 'en3',
    category: 'environment',
    text: "새로운 환경이나 변화에 적응하는 것이 편하다.",
    type: 'likert'
  },
  {
    id: 'en4',
    category: 'environment',
    text: "업무 처리 시 선호하는 방식은?",
    type: 'choice',
    options: [
      { label: "개별화된 맞춤형 접근", value: "personalized" },
      { label: "표준화된 프로세스 적용", value: "standardized" }
    ]
  },
  {
    id: 'en5',
    category: 'environment',
    text: "다양한 업무를 동시에 처리하는 것에 능숙하다.",
    type: 'likert'
  },
  // 가치 및 동기 질문
  {
    id: 'va1',
    category: 'values',
    text: "업무 수행 시 가장 큰 보람을 느끼는 때는?",
    type: 'choice',
    options: [
      { label: "고객 만족과 긍정적 피드백", value: "satisfaction" },
      { label: "목표 달성과 성과 창출", value: "achievement" }
    ]
  },
  {
    id: 'va2',
    category: 'values',
    text: "전문가로서 가장 중요하게 생각하는 것은?",
    type: 'choice',
    options: [
      { label: "분석력과 전문성", value: "expertise" },
      { label: "고객 이해와 서비스 품질", value: "service" }
    ]
  },
  {
    id: 'va3',
    ...
    type: 'choice',
    options: [
      { label: "정확성과 전문성", value: "accuracy" },
      { label: "혁신과 창의성", value: "innovation" }
    ]
  },
  {
    id: 'va4',
    category: 'values',
    text: "변화와 혁신에 대한 나의 태도는?",
    type: 'choice',
    options: [
      { label: "적극적인 변화 주도", value: "proactive" },
      { label: "신중한 검토 후 수용", value: "cautious" }
    ]
  },
  {
    id: 'va5',
    category: 'values',
    text: "성과 달성을 위해 중요하게 생각하는 것은?",
    type: 'choice',
    options: [
      { label: "분석적 접근과 전략적 사고", value: "analytical" },
      { label: "팀워크와 협력", value: "teamwork" }
    ]
  }
];
